...
`,
    ...
    assert
      .dom('.self-executing-code-block .example h2')
      .hasText('I am in a sample');
    assert
      .dom('.self-executing-code-block pre.language-html code.language-html')
      .exists();
  });
